...
public class MainActivity extends AppCompatActivity implements Gota.OnRequestPermissionsBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wRecognizer = SpeechRecognizer.createSpeechRecognizer(this);
        wRecognizer.setRecognitionListener(listener);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                wRecognizer.startListening(intent);
            }
        });
    ...
    private RecognitionListener listener =new RecognitionListener() {
        ...
        public void onResults(Bundle results) {
            ...
            ArrayList<String> wResuit = results.getStringArrayList(key);
            String[] rs=new String[wResuit.size()];
            wResuit.toArray(rs);
